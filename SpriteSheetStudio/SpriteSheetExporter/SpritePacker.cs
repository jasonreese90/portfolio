...
namespace SpriteSheetExporter
{
    ...
    public static class SpritePacker
    {
        ...
        /// </summary>
        static Image CopySpritesToOutput(List<ArrangedSprite> sprites,
                                                 IList<Sprite> sourceSprites,
                                                 ICollection<Rectangle> outputSprites,
                                                 int width, int height)
        {
            ...
            using (Graphics g = Graphics.FromImage(output))
            {
                ...
                {
                    Image source = sourceSprites[sprite.Index].Image;
                    ...
                    g.DrawImage(source, new Rectangle(x + 1, y + 1, w, h), new Rectangle(0, 0, w, h),
                                    GraphicsUnit.Pixel);
                    ...
                    g.DrawImage(source, new Rectangle(x, y + 1, 1, h), new Rectangle(0, 0, 1, h), GraphicsUnit.Pixel);

                    g.DrawImage(source, new Rectangle(x + w + 1, y + 1, 1, h), new Rectangle(w - 1, 0, 1, h), GraphicsUnit.Pixel);

                    g.DrawImage(source, new Rectangle(x + 1, y, w, 1), new Rectangle(0, 0, w, 1), GraphicsUnit.Pixel);

                    g.DrawImage(source, new Rectangle(x + 1, y + h + 1, w, 1), new Rectangle(0, h - 1, w, 1), GraphicsUnit.Pixel);

                    // Copy a single pixel from each corner of the sprite,
                    // filling in the corners of the one pixel padding area.
                    g.DrawImage(source, new Rectangle(x, y, 1, 1), new Rectangle(0, 0, 1, 1), GraphicsUnit.Pixel);

                    g.DrawImage(source, new Rectangle(x + w + 1, y, 1, 1), new Rectangle(w - 1, 0, 1, 1), GraphicsUnit.Pixel);

                    g.DrawImage(source, new Rectangle(x, y + h + 1, 1, 1), new Rectangle(0, h - 1, 1, 1), GraphicsUnit.Pixel);

                    g.DrawImage(source, new Rectangle(x + w + 1, y + h + 1, 1, 1), new Rectangle(w - 1, h - 1, 1, 1), GraphicsUnit.Pixel);
